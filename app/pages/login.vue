          ...
          <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            <div class="mb-5 sm:mb-8">
              ...
              <p class="text-sm text-gray-500 dark:text-gray-400">
                <template v-if="currentClub">Sign in to access {{ currentClub.name }}</template>
                <template v-else>Enter your email and password to sign in!</template>
              </p>
            </div>
            ...
            <div>
              <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5">
                ...
                <button type="button" @click="handleXLogin"
                  class="inline-flex items-center justify-center gap-3 py-3 text-sm font-normal text-gray-700 transition-colors bg-gray-100 rounded-lg px-7 hover:bg-gray-200 hover:text-gray-800 dark:bg-white/5 dark:text-white/90 dark:hover:bg-white/10">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="fill-current">
                    <path d="M15.2033 2H17.8433L11.8233 8.89L18.8633 18H13.3033L9.01333 12.41L4.11333 18H1.47333L7.89333 10.61L1.13333 2H6.83333L10.7233 7.12L15.2033 2ZM14.2333 16.36H15.7633L5.82333 3.56H4.17333L14.2333 16.36Z" />
                  </svg>
                  Sign in with X
                </button>
              </div>
              ...
              <div class="mt-5">
                <p class="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                  ...
                  <NuxtLink to="/register" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">
                    Sign Up
                  </NuxtLink>
                </p>
              </div>
