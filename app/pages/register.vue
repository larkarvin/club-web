          ...
          <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            <div class="mb-5 sm:mb-8">
              <h1 class="mb-2 font-semibold text-gray-800 text-title-sm dark:text-white/90 sm:text-title-md">
                <template v-if="currentClub">Join {{ currentClub.name }}</template>
                <template v-else>Create Account</template>
              </h1>
              <p class="text-sm text-gray-500 dark:text-gray-400">
                <template v-if="currentClub">Create an account to join this club</template>
                <template v-else>Enter your details to create your account</template>
              </p>
            </div>
            ...
            <div>
              ...
              <Form @submit="handleSubmit" :validation-schema="schema" v-slot="{ isSubmitting }">
                <div class="space-y-5">
              ...
              <div class="mt-5">
                <p class="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                  ...
                  <NuxtLink to="/login" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">
                    Sign In
                  </NuxtLink>
                </p>
              </div>
