    ...
    <div>
      ...
      <div class="flex items-end justify-between py-5">
        ...
        <div class="w-full max-w-[150px]">
          <ClientOnly>
            <VueApexCharts type="area" height="70" :options="chartNineOptions" :series="chartNineData"></VueApexCharts>
          </ClientOnly>
        </div>
      </div>

      <!-- Stats item -->
      <div class="flex items-end justify-between py-5 border-gray-100 border-y dark:border-gray-800">
        <div>
        ...
        <div class="w-full max-w-[150px]">
          <ClientOnly>
            <VueApexCharts type="area" height="70" :options="chartTenOptions" :series="chartTenData"></VueApexCharts>
          </ClientOnly>
        </div>
      </div>
