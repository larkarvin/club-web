<template>
  <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
    <div class="flex justify-between">
      <div>
        <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Estimated Revenue</h3>
    ...
    <div class="relative">
      <div id="chartTwelve">
        <ClientOnly>
          <VueApexCharts type="radialBar" height="360" :options="chartOptions" :series="series"></VueApexCharts>
        </ClientOnly>
      </div>
    ...
    <div class="pt-6 mt-6 space-y-5 border-t border-gary-200 dark:border-gray-800">
      <div>
        <p class="mb-2 text-gray-500 text-theme-sm dark:text-gray-400">Marketing</p>
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-4">
            <div>
              <p class="text-base font-semibold text-gray-800 dark:text-white/90">$30,569.00</p>
            </div>
          </div>
          ...
          <div class="flex w-full max-w-[140px] items-center gap-3">
            ...
            <p class="font-medium text-gray-700 text-theme-sm dark:text-gray-400">85%</p>
          </div>
        </div>
      </div>

      <div>
        <p class="mb-2 text-gray-500 text-theme-sm dark:text-gray-400">Sales</p>
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-4">
            <div>
              <p class="text-base font-semibold text-gray-800 dark:text-white/90">$20,486.00</p>
            </div>
          </div>
