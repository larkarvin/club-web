  ...
  >
    ...
    <div class="flex gap-4 sm:gap-9">
      <div class="flex items-start gap-2">
        <div>
          <h4 class="mb-0.5 text-base font-bold text-gray-800 dark:text-white/90 sm:text-theme-xl">$212,142.12</h4>
      ...
      <div class="flex items-start gap-2">
        <div>
          <h4 class="mb-0.5 text-base font-bold text-gray-800 dark:text-white/90 sm:text-theme-xl">$30,321.23</h4>
          <span class="text-gray-500 text-theme-xs dark:text-gray-400"> Avg. Yearly Profit </span>
        </div>
    ...
    <div class="max-w-full overflow-x-auto custom-scrollbar">
      <div id="chartEleven" class="-ml-4 min-w-[1000px] pl-2 xl:min-w-full">
        <ClientOnly>
          <VueApexCharts type="area" height="220" :options="chartOptions" :series="series"></VueApexCharts>
        </ClientOnly>
      </div>
    </div>
  </div>
