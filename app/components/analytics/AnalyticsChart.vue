  ...
  >
    <div class="flex flex-wrap items-start justify-between gap-5">
      <div>
        ...
        <span class="block text-gray-500 text-theme-sm dark:text-gray-400"> Visitor analytics of last 30 days </span>
      </div>
    ...
    <div class="max-w-full overflow-x-auto custom-scrollbar">
      <div id="chartFour" class="-ml-5 min-w-[1300px] xl:min-w-full pl-2">
        <ClientOnly>
          <VueApexCharts width="100%" height="350" type="bar" :options="chartOptions" :series="series" />
        </ClientOnly>
      </div>
    </div>
  </div>
...
const series = ref([
  {
    name: 'Sales',
    data: [
      168, 385, 201, 298, 187, 195, 291, 110, 215, 390, 280, 112, 123, 212, 270, 190, 310, 115, 90, 380, 112, 223, 292,
      170, 290, 110, 115, 290, 380, 312,
    ],
  },
]);
