  ...
  <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
    ...
    <div class="mt-6 flex items-end gap-1.5">
      <div class="flex items-center gap-2.5 relative">
        ...
        <span class="font-semibold text-gray-800 activeUsers text-title-sm dark:text-white/90"> 364 </span>
      </div>
    ...
    <div class="flex items-center justify-center gap-6">
      ...
      <div>
        ...
        <p class="mt-0.5 text-center text-theme-xs text-gray-500 dark:text-gray-400">Avg, Monthly</p>
      </div>
    </div>
  </div>
</template>
