  ...
  <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
    <div class="flex justify-between mb-6">
      ...
      <div class="stocks-slider-outer relative flex items-center gap-1.5">
        <button ref="prevEl" class="swiper-button-prev flex items-center justify-center">
          <svg
        ...
        <button ref="nextEl" class="swiper-button-next flex items-center justify-center">
          <svg
            class="stroke-current"
            width="16"
            height="16"
            ...
            <div class="flex items-center justify-between pb-5 mb-5 border-b border-gray-200 dark:border-gray-800">
              ...
              <div>
                ...
                <span
                  ...
                  :class="
                    stock.change >= 0 ? 'text-success-600 dark:text-success-500' : 'text-error-600 dark:text-error-500'
                  "
                >
                  <svg v-if="stock.change >= 0" class="fill-current" width="12" height="12" viewBox="0 0 12 12">
                    <path
                      d="M5.56462 1.62394C5.70193 1.47073 5.90135 1.37433 6.12329 1.37433C6.31631 1.37416 6.50845 1.44732 6.65505 1.59381L9.65514 4.59181C9.94814 4.8846 9.94831 5.35947 9.65552 5.65247C9.36273 5.94546 8.88785 5.94563 8.59486 5.65284L6.87329 3.93248L6.87329 10.125C6.87329 10.5392 6.53751 10.875 6.12329 10.875C5.70908 10.875 5.37329 10.5392 5.37329 10.125L5.37329 3.93579L3.65516 5.65282C3.36218 5.94562 2.8873 5.94547 2.5945 5.65249C2.3017 5.3595 2.30185 4.88463 2.59484 4.59183L5.56462 1.62394Z"
                    />
                  </svg>
...
const stocks = ref([
  { symbol: 'TSLA', name: 'Tesla, Inc', logo: '/images/brand/brand-09.svg', price: '$192.53', change: 1.01 },
  { symbol: 'AAPL', name: 'Apple, Inc', logo: '/images/brand/brand-07.svg', price: '$192.53', change: 3.59 },
  { symbol: 'SPOT', name: 'Spotify, Inc', logo: '/images/brand/brand-11.svg', price: '$192.53', change: 1.01 },
  { symbol: 'PYPL', name: 'Paypal, Inc', logo: '/images/brand/brand-08.svg', price: '$192.53', change: 1.01 },
  { symbol: 'AMZN', name: 'Amazon, Inc', logo: '/images/brand/brand-10.svg', price: '$192.53', change: 1.01 },
]);

const shortStock = (stock) => console.log(`Shorting ${stock.symbol}`);
const buyStock = (stock) => console.log(`Buying ${stock.symbol}`);
</script>
